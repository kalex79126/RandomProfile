...
namespace RandomProfileMAUI.Utilities
{
    public static class Jeeves
    {
        //For Local API
        //public static Uri DBUri = new Uri("https://localhost:7184/swagger/index.html");
        //WebApi on Azure
        public static Uri DBUri = new Uri("https://athletewebapi.azurewebsites.net/swagger");
